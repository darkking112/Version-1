...
function AppointmentBooking({ donationCenters, donor }) {
    ...
    const viewTimeSlots = async (id) => {
        ...
        try {
            const response = await fetch('http://localhost:5000/donor/view-available-appointments', {
                method: 'POST',
                headers: {
    ...
    const handleConfirmPersonalInfo = async (donor) => {
        console.log(donor);
        try {
        const response = await fetch(`http://localhost:5000/donor/edit-personal-data/${donor.Donor_ID}`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
    ...
    const handleConfirmAppointment = async () => {
        console.log(donor);
        try {
        const response = await fetch('http://localhost:5000/donor/book-an-appointment', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
