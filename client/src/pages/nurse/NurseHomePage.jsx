...
function NurseHomePage() {
    ...
    const handleApprovement = (appointment) => {
        fetch(`${process.env.REACT_APP_BACKEND_URL}/nurse/change-appointment-status/${appointment.Appointment_ID}`, {
            method: 'POST'
        })
            .then(response => response.json())
            .then(data => {
    ...
    const confrimAppointment = (type, amount) => {
        fetch(`${process.env.REACT_APP_BACKEND_URL}/nurse/approve-appointment/${approvedAppointment.Appointment_ID}`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    const rejectAppointment = (appointment) => {
        fetch(`${process.env.REACT_APP_BACKEND_URL}/nurse/reject-appointment/${appointment.Appointment_ID}`, {
            method: 'POST'
        })
            .then(response => response.json())
            .then(data => {
